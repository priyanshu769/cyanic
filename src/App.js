    ...
    <div className="App">
      <nav className="navbar">
        <ul className="navPills listStyleNone listInline">
          ...
          <li className="navPill"><Link className="link" activeClassName="selectedNavPill" to="playlists">Playlists</Link></li>
          <li className="navPill"><Link className="link" activeClassName="selectedNavPill" to="liked-videos">Likes</Link></li>
        </ul>
      </nav>
      <Routes>
